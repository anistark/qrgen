    ...
    <v-container fluid class="my-4">
        <v-layout wrap align-center justify-center row fill-height class="py-5">
            <v-flex xs12 sm7 md7 lg7 xl7 class="px-5 py-5">
                ...
                <p class="google-font mb-0 mt-5 mb-1" style="font-size:140%">Generate QR Codes Easily</p>
                <p class="google-font mb-0" style="font-size:100%">Generate easy and quick QR Codes ready to be integrated into your business. We provide custom QR Codes as well with your branding.</p>
                ...
                <v-btn aria-label="Start Generating" target="_blank" class="ma-0 google-font elevation-1" color="#1a73e8" style="text-transform: capitalize;border-radius:5px;color:white">Start Generating</v-btn>
           ...
           <v-flex xs12 sm5 md3 lg5 xl5 class="text-xs-center ">
                <v-img
                    ...
                    :lazy-src="require('@/assets/img/bg2.png')"
                    width="100%">
                    <v-layout
                        slot="placeholder"
                        fill-height
